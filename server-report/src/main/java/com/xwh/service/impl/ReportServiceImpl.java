...
public class ReportServiceImpl implements ReportService {
    ...
    public SalesTop10ReportVO getSalesTop10(LocalDate begin, LocalDate end) {
        ...
        map.put("end",endTime);
        List<GoodsSalesDTO> salesTop10 = orderClient.getSalesTop10(map);
    ...
    public void exportBusinessData(HttpServletResponse response) {
        ...
        HashMap<String, LocalDateTime> map = new HashMap<>();
        map.put("start",LocalDateTime.of(dateBegin, LocalTime.MIN));
        map.put("end", LocalDateTime.of(dateEnd, LocalTime.MAX));
        //查询概览数据
        BusinessDataVO businessDataVO = workspaceClient.getSomedayBusinessData(map);
        ...
        try {
            ...
            for (int i = 0; i < 30; i++) {
                ...
                //查询某一天的营业数据
                BusinessDataVO businessData = workspaceClient.getSomedayBusinessData(map);
